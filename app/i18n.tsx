...
const STRINGS: Record<Lang, Strings> = {
  es: {
    ...
    heroH1Span: "",
    heroBody:
      "Desarrollador full-stack y automatizador. Diseño software útil, claro y hecho a medida para empresas que quieren dar el salto digital.",
  ...
  en: {
    ...
    heroH1Span: "",
    heroBody:
      "Full-stack developer and automation specialist. I design useful, clear, custom software for companies ready to take the digital leap.",
